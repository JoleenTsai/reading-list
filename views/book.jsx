  ...
  <Fragment>
    {props.isRead ?
      ...
      <div className="card mb-3" key={props.title}>
        <div className="card-header" id="bookName">
          <h4>{props.title}
            <a href="/list" id="editBTN" className="btn btn-secondary btn-sm float-right">Edit</a>
            <a href="/list" id="deleteBTN" className="btn btn-danger btn-sm float-right">Delete</a>
          </h4>
        </div>
        <ul className="list-group list-group-flush">
          <li id="bookAuthor" className="list-group-item">Author: {props.author}</li>
